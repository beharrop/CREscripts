...
#SBATCH --job-name=pcre_hourly
#SBATCH --output=pcre_hourly.o%j
#SBATCH --error=pcre_hourly.e%j
#SBATCH --nodes=1
#SBATCH --qos=regular
...
outstring=${run_name}.1H_cre_data.${years_out}.nc
cat_name=${run_name}.concat.1H_cre_data.${years_out}.nc
...
mid_name_1=temp_file_make_vars.1H.nc
mid_name_2=temp_file_trimmed.1H.nc
