...
#SBATCH --job-name=pcre_control
#SBATCH --output=pcre_control.o%j
#SBATCH --error=pcre_control.e%j
#SBATCH --nodes=1
#SBATCH --qos=debug
...
outstring=${run_name}.5D_cre_data.${years_out}.nc
cat_name=${run_name}.concat.5D_cre_data.${years_out}.nc
...
mid_name_1=temp_file_make_vars.5D.nc
mid_name_2=temp_file_trimmed.5D.nc
